...
#define BUS_USART6_RX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()
#define BUS_USART6_RX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOA_CLK_DISABLE()
#define BUS_USART6_RX_GPIO_PIN GPIO_PIN_12
#define BUS_USART6_RX_GPIO_AF GPIO_AF8_USART6
#define BUS_USART6_RX_GPIO_PORT GPIOA
