...
int XNUCLEO53L0A1_Init(void) {
    ...
    //XNUCLEO53L0A1_USART2_UART_Init(); // Commented out, code that is generated by cube
    XNUCLEO53L0A1_I2C1Configure(); // usseles beside _I2cFailRecover AND NO PULLUP CONFIG IN I2C
    return HAL_OK;
